...
const requirements = new Map([
  ...
  [
    ...
    [
      ...
      "`aw shell init <shell>` emits only the manual wrapper",
      "`aw shell install` owns both wrapper and completion activation lines",
  ...
  [
    ...
    [
      "aw completion bash",
      "run `command aw completion <shell>` directly",
