...
entry_commands:
  ...
  workflows:
    ...
    intermediate: arashi add <repo-url> && arashi clone --all && arashi create <branch> && arashi switch <branch>
...
- Intermediate: add repositories, clone missing repos, and create a feature branch.
...
- **Intermediate**: repositories added, missing clones recovered, and feature branch worktrees created.
